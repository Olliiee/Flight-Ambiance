...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Strausshome.FS.CrewSoundsNG.Models.FlightStatus", b =>
                {
                    ...
                    b.Property<int?>("FlightStatusProfileProfileId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("IsDoorOpen")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IsEngineRun")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IsGearDown")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IsOnGround")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IsParkingBrakeSet")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("FlightStatusProfileProfileId");
            ...
            modelBuilder.Entity("Org.Strausshome.FS.CrewSoundsNG.Models.FlightStatus", b =>
                {
                    b.HasOne("Org.Strausshome.FS.CrewSoundsNG.Models.FlightStatusProfile", null)
                        .WithMany("FlightStatus")
                        .HasForeignKey("FlightStatusProfileProfileId");
                });
            ...
            modelBuilder.Entity("Org.Strausshome.FS.CrewSoundsNG.Models.ProfileItem", b =>
                {
                    ...
                    b.HasOne("Org.Strausshome.FS.CrewSoundsNG.Models.Profile", null)
